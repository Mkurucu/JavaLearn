package HLK_OrS1.j16_ArrayList.Tasks;
...
public class Task12_Manav {
    ...
    private static void musteriSecim() {
        ...
        toplamOdenecekTutar += kilo * urunFiyatlari.get(secim - 1);//alınan her urun odemesi ana odemeye eklendi
        System.out.println("Sectiginiz urun: " + urunListesi.get(secim + 1));
        System.out.println("Urun Fiyati: " + kilo * urunFiyatlari.get(secim - 1));

        System.out.println("dewamkee  1, kasa için 2 seciniz...");
